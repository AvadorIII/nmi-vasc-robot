...
Example test data are provided in the folders ```/data/nir_test``` and ```/data/nir_test```. Each directory contains four contiguous test sequences. Individual data are in the form of .mat files, structured as follows:
