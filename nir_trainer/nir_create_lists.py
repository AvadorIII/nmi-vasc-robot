...
datalist_test = [[datapath + 'sequence1\\', -1, 0, 9999, 1],
                 [datapath + 'sequence2\\', -1, 0, 9999, 1],
                 [datapath + 'sequence3\\', -1, 0, 9999, 1],
                 [datapath + 'sequence4\\', -1, 0, 9999, 1]]
...
context_backtrack_train = 0.8
context_backtrack_val = 0.8
